...
class CommonMark
{
    ...
    public function test_empty( )
    {
        ...
        asserts.assert(n.render(ncrCommmonMark(Necmark.OPT_DEFAULT | Necmark.RENDER_OPT_UNSAFE)) == expected);
    ...
    public function test_no_breaks_and_width( )
    {
        ...
        asserts.assert(n.render(ncrCommmonMark(Necmark.RENDER_OPT_NOBREAKS | Necmark.RENDER_OPT_UNSAFE)) == expected);
        asserts.assert(n.render(ncrCommmonMark(Necmark.RENDER_OPT_NOBREAKS | Necmark.RENDER_OPT_UNSAFE, 0)) == expected);
        asserts.assert(n.render(ncrCommmonMark(Necmark.RENDER_OPT_NOBREAKS | Necmark.RENDER_OPT_UNSAFE, 7)) == expected);

        n.close();
        return asserts.done();
    }

    @:describe('Test Hard breaks and Width')
    public function test_hard_breaks_and_width( )
    {
        var expected = ""
            + "My humble mentoring experience tells me something about "
            + "learning programming. For complete beginners, it may be easier "
        ...
        asserts.assert(n.render(ncrCommmonMark(Necmark.RENDER_OPT_HARDBREAKS | Necmark.RENDER_OPT_UNSAFE)) == expected);
        asserts.assert(n.render(ncrCommmonMark(Necmark.RENDER_OPT_HARDBREAKS | Necmark.RENDER_OPT_UNSAFE, 0)) == expected);
        asserts.assert(n.render(ncrCommmonMark(Necmark.RENDER_OPT_HARDBREAKS | Necmark.RENDER_OPT_UNSAFE, 7)) == expected);
    ...
    public function test_soft_breaks_and_zero_width( )
    {
        ...
        asserts.assert(n.render(ncrCommmonMark(Necmark.OPT_DEFAULT | Necmark.RENDER_OPT_UNSAFE)) == expected);
        asserts.assert(n.render(ncrCommmonMark(Necmark.OPT_DEFAULT | Necmark.RENDER_OPT_UNSAFE, 0)) == expected);
    ...
    public function test_soft_breaks_and_non_zero_width( )
    {
        ...
        asserts.assert(n.render(ncrCommmonMark(Necmark.OPT_DEFAULT | Necmark.RENDER_OPT_UNSAFE, 7)) == expected);
